...
<head>
    ...
    <title>Edit Makanan & Minuman - Pusat Kebutuhan Kucing Terlengkap!</title>
    <style>
        html {
            /* width: 100%;
            overflow: hidden; */
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        ?>
                        <h2 class="text-center">Edit Makanan & Minuman</h2>
                        <img src="./assets/imgFood/<?= $makanan['gambar']; ?>" width="200" class="mb-y">
                        <form method="POST" action="./editFoodAksi.php" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?= $makanan['id_makanan_properti']; ?>">
                            <div class="form-group">
                                <label for="nama">Nama</label>
                                <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Makanan" value="<?= $makanan['nama']; ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="deskripsi">Keterangan</label>
                                <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3"><?= $makanan['deskripsi'] ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="harga">Harga</label>
                                <input type="number" class="form-control" id="harga" name="harga" placeholder="Masukkan Harga Makanan" value="<?= $makanan['harga']; ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="gambarBaru">Gambar</label>
                                <input type="hidden" name="gambar" value="<?= $makanan['gambar']; ?>">
