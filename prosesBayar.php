...
<head>
    ...
    <title>Proses Bayar - Pusat Kebutuhan Kucing Terlengkap!</title>
    <style>
        html {
            /* width: 100%;
            overflow: hidden; */
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        ?>
                        <h2 class="text-center">Proses Bayar</h2>
                        <form method="POST" action="./prosesBayarAksi.php" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?= $transaksi['id_transaksi']; ?>">
                            <input type="hidden" name="harga" value="<?= $transaksi['harga']; ?>">
                            <div class="form-group">
                                <label for="nama">Nama</label>
                                <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama transaksi" value="<?= $transaksi['nama']; ?>" disabled>
                            </div>
                            <div class="form-group">
                                <label for="harga">Harga</label>
                                <input type="number" class="form-control" id="harga" name="harga" placeholder="Masukkan Harga transaksi" value="<?= $transaksi['harga']; ?>" disabled>
                            </div>
                            <div class="form-group">
