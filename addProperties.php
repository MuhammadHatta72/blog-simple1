...
<head>
    ...
    <title>Tambah Properti - Pusat Kebutuhan Kucing Terlengkap!</title>
    <style>
        html {
            /* width: 100%;
            overflow: hidden; */
    ...
    <div class="container my-5">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-center">Tambah Properti</h2>
                        <form method="POST" action="./addPropertiesAksi.php" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="nama">Nama</label>
                                <input type="text" class="form-control" id="nama" placeholder="Masukkan Nama Properti" name="nama" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="harga" name="harga" placeholder="Masukkan Harga Properti" required>
                            </div>
                            <div class="form-group">
                                <label for="stok">Stok</label>
                                <input type="text" class="form-control" id="stok" name="stok" placeholder="Masukkan Stok Properti" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="submit" class="btn btn-primary" name="submit" value="Simpan Properti" required>
                            </div>
                        </form>
                    </div>
                </div>
